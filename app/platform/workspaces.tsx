...
import { usePlatform } from './_layout';
...
export default function WorkspacesPage() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '100%', minHeight: '60vh', gap: 12, padding: '0 24px', textAlign: 'center', fontFamily: 'system-ui, sans-serif' }}>
      <div style={{ width: 56, height: 56, borderRadius: 14, marginBottom: 4, background: 'linear-gradient(135deg, #312e81, #312e81)', border: '1px solid #4f46e5', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      ...
      <h2 style={{ fontSize: 16, fontWeight: 700, color: 'var(--bld-text-1)', margin: 0 }}>No workspaces yet</h2>
